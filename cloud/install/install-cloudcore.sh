...
# =====================================
echo "" | tee -a "$INSTALL_LOG"
echo "[1/9] 检查前置条件..." | tee -a "$INSTALL_LOG"
...
# =====================================
echo "" | tee -a "$INSTALL_LOG"
echo "[2/9] 加载 KubeEdge 镜像到 containerd..." | tee -a "$INSTALL_LOG"
...
# =====================================
echo "" | tee -a "$INSTALL_LOG"
echo "[3/9] 初始化 CloudCore..." | tee -a "$INSTALL_LOG"
...
# =====================================
echo "" | tee -a "$INSTALL_LOG"
echo "[4/9] 应用 CloudCore 功能配置..." | tee -a "$INSTALL_LOG"
...
# =====================================
# 步骤 5: 部署 KubeEdge Controller Manager
# =====================================
echo "" | tee -a "$INSTALL_LOG"
echo "[5/9] 部署 KubeEdge Controller Manager..." | tee -a "$INSTALL_LOG"
...
# =====================================
# 步骤 6: 安装 Istio CRDs（EdgeMesh 依赖）
# =====================================
echo "" | tee -a "$INSTALL_LOG"
echo "[6/9] 安装 Istio CRDs（EdgeMesh 依赖）..." | tee -a "$INSTALL_LOG"
...
# =====================================
# 步骤 7: 安装 EdgeMesh（可选，检测到 Helm Chart 时自动安装）
# =====================================
echo "" | tee -a "$INSTALL_LOG"
echo "[7/9] 安装 EdgeMesh..." | tee -a "$INSTALL_LOG"
...
# =====================================
# 步骤 8: 获取并保存 Edge Token
# =====================================
echo "" | tee -a "$INSTALL_LOG"
echo "[8/9] 获取 Edge Token..." | tee -a "$INSTALL_LOG"
...
# =====================================
echo "" | tee -a "$INSTALL_LOG"
echo "[9/9] 安装验证..." | tee -a "$INSTALL_LOG"
